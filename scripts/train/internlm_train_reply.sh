...
CUDA_VISIBLE_DEVICES=0,1 swift sft --torch_dtype bfloat16 \
    ...
    --adapters ./output/internlm2_5_reply/2022/checkpoint-600 \
...
CUDA_VISIBLE_DEVICES=0,1 swift sft --torch_dtype bfloat16 \
    ...
    --adapters ./output/internlm2_5_reply/2023/checkpoint-600 \
...
CUDA_VISIBLE_DEVICES=0,1 swift sft --torch_dtype bfloat16 \
    ...
    --adapters ./output/internlm2_5_reply/2024/checkpoint-760 \
