...
CUDA_VISIBLE_DEVICES=0,1  swift sft --torch_dtype 'bfloat16' \
    ...
    --eval_steps '50' \
    --output_dir './output/internlm2/cia/2022' \
    --use_dema True \
    --base_weight 0.001
...
CUDA_VISIBLE_DEVICES=0,1  swift sft --torch_dtype 'bfloat16' \
    ...
    --gradient_accumulation_steps '1' \
    --eval_steps '50' \
    --output_dir './output/internlm2/cia/2023' \
    --adapters ./output/internlm2/cia/2022/checkpoint-520 \
    --use_dema True \
    --base_weight 0.001
...
CUDA_VISIBLE_DEVICES=0,1  swift sft --torch_dtype 'bfloat16' \
    ...
    --gradient_accumulation_steps '1' \
    --eval_steps '50' \
    --output_dir './output/internlm2/cia/2024' \
    --adapters ./output/internlm2/cia/2023/checkpoint-540 \
    --use_dema True \
    --base_weight 0.001
...
CUDA_VISIBLE_DEVICES=0,1  swift sft --torch_dtype 'bfloat16' \
    ...
    --gradient_accumulation_steps '1' \
    --eval_steps '50' \
    --output_dir './output/internlm2/cia/2025' \
    --adapters ./output/internlm2/cia/2024/checkpoint-680 \
    --use_dema True \
    --base_weight 0.001
