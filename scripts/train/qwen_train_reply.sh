...
CUDA_VISIBLE_DEVICES=0,1 swift sft --torch_dtype bfloat16 \
    ...
    --resume_from_checkpoint ./output/qwen2_5_reply/2022/checkpoint-600 \
...
CUDA_VISIBLE_DEVICES=0,1 swift sft --torch_dtype bfloat16 \
    ...
    --resume_from_checkpoint ./output/qwen2_5_reply/2023/checkpoint-6000 \
    --resume_only_model True \
...
CUDA_VISIBLE_DEVICES=0,1 swift sft --torch_dtype bfloat16 \
    ...
    --resume_from_checkpoint ./output/qwen2_5_reply/2024/checkpoint-7600 \
    --resume_only_model True \
