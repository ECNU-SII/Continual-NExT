...
CUDA_VISIBLE_DEVICES=0,1 swift sft --torch_dtype bfloat16 \
    ...
    --resume_from_checkpoint ./output/internlm2_5_lwf/2022/checkpoint-560 \
...
CUDA_VISIBLE_DEVICES=0,1 swift sft --torch_dtype bfloat16 \
    ...
    --resume_from_checkpoint ./output/internlm2_5_lwf/2023/checkpoint-560 \
    --resume_only_model True \
    --use_lwf True
...
CUDA_VISIBLE_DEVICES=0,1 swift sft --torch_dtype bfloat16 \
    ...
    --resume_from_checkpoint ./output/internlm2_5_lwf/2024/checkpoint-720 \
    --resume_only_model True \
    --use_lwf True
