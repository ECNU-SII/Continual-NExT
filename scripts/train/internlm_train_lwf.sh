...
CUDA_VISIBLE_DEVICES=0,1 swift sft --torch_dtype bfloat16 \
    ...
    --adapters ./output/internlm2_5_lwf/2022/checkpoint-520 \
    --use_lwf True
...
CUDA_VISIBLE_DEVICES=0,1 swift sft --torch_dtype bfloat16 \
    ...
    --adapters ./output/internlm2_5_lwf/2023/checkpoint-540 \
    --use_lwf True
...
CUDA_VISIBLE_DEVICES=0,1 swift sft --torch_dtype bfloat16 \
    ...
    --adapters ./output/internlm2_5_lwf/2024/checkpoint-680 \
    --use_lwf True
