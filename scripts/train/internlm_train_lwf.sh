...
CUDA_VISIBLE_DEVICES=0,1 swift sft --torch_dtype bfloat16 \
    ...
    --adapters ./output/internlm2_5_lwf/2022/checkpoint-560 \
    --use_lwf True
...
CUDA_VISIBLE_DEVICES=0,1 swift sft --torch_dtype bfloat16 \
    ...
    --adapters ./output/internlm2_5_lwf/2023/checkpoint-560 \
    --use_lwf True
...
CUDA_VISIBLE_DEVICES=0,1 swift sft --torch_dtype bfloat16 \
    ...
    --adapters ./output/internlm2_5_lwf/2024/checkpoint-720 \
    --use_lwf True
