...
CUDA_VISIBLE_DEVICES=0,1 swift sft --torch_dtype bfloat16 \
    --add_version False \
    --deepspeed zero0 \
    --model Qwen/Qwen2.5-7b --model_type qwen2_5 --template qwen2_5 \
...
CUDA_VISIBLE_DEVICES=0,1 swift sft --torch_dtype bfloat16 \
    ...
    --dataset datasets/2023-train.json --split_dataset_ratio 0 --max_length 4096 --train_dataloader_shuffle False --dataloader_num_workers 4 \
    ...
    --resume_from_checkpoint ./output/qwen2_5_lwf/2022/checkpoint-560 \
...
CUDA_VISIBLE_DEVICES=0,1 swift sft --torch_dtype bfloat16 \
    ...
    --dataset datasets/2024-train.json --split_dataset_ratio 0 --max_length 4096 --train_dataloader_shuffle False --dataloader_num_workers 4 \
    ...
    --resume_from_checkpoint ./output/qwen2_5_lwf/2023/checkpoint-560 \
    --resume_only_model True \
    --use_lwf True --use_logits_to_keep True
...
CUDA_VISIBLE_DEVICES=0,1 swift sft --torch_dtype bfloat16 \
    ...
    --dataset datasets/2025-train.json --split_dataset_ratio 0 --max_length 4096 --train_dataloader_shuffle False --dataloader_num_workers 4 \
    ...
    --resume_from_checkpoint ./output/qwen2_5_lwf/2024/checkpoint-720 \
    --resume_only_model True \
    --use_lwf True --use_logits_to_keep True
