...
CUDA_VISIBLE_DEVICES=0,1 swift sft --torch_dtype bfloat16 \
    ...
    --dataset datasets/2023.json --split_dataset_ratio 0 --max_length 4096 --train_dataloader_shuffle False --dataloader_num_workers 4 \
    ...
    --adapters ms-swift-main/output/qwen2_5_lwf/2022/checkpoint-520 \
