...
CUDA_VISIBLE_DEVICES=0,1 swift sft --torch_dtype bfloat16 \
    ...
    --resume_from_checkpoint ./output/internlm2/moe/2022/checkpoint-560 \
...
CUDA_VISIBLE_DEVICES=0,1 swift sft --torch_dtype bfloat16 \
    ...
    --resume_from_checkpoint ./output/internlm2/moe/2023/checkpoint-560 \
    --resume_only_model True
...
CUDA_VISIBLE_DEVICES=0,1 swift sft --torch_dtype bfloat16 \
    ...
    --resume_from_checkpoint ./output/internlm2/moe/2024/checkpoint-720 \
    --resume_only_model True
