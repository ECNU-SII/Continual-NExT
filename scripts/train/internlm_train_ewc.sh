...
CUDA_VISIBLE_DEVICES=0,1  swift sft --torch_dtype 'bfloat16' \
    ...
    --resume_from_checkpoint ./output/internlm2/ewc/2022/checkpoint-560 \
...
CUDA_VISIBLE_DEVICES=0,1  swift sft --torch_dtype 'bfloat16' \
    ...
    --resume_from_checkpoint ./output/internlm2/ewc/2023/checkpoint-560 \
    --resume_only_model True \
    --EWC True \
    --EWC_lambda 0.5 \
    --EWC_limit 200 \
...
CUDA_VISIBLE_DEVICES=0,1  swift sft --torch_dtype 'bfloat16' \
    ...
    --resume_from_checkpoint ./output/internlm2/ewc/2024/checkpoint-720 \
    --resume_only_model True \
    --EWC True \
    --EWC_lambda 0.5 \
    --EWC_limit 200 \
