...
class MoELoraModel(BaseTuner):
    ...
    **Attributes**:
    ...
    def __init__(self, model, config, adapter_name, low_cpu_mem_usage: bool = False) -> None:
        ...
        self.p_grad_data = {}
        self.dema = True
        print("fgjlkvhljife;hbkl;dshfklu;pdhnfjlk;dsfhljdshjfjlk;dshfjklhjlds;hflj;kdshfljkdsh")
    ...
    def _prepare_model(self, peft_config: MoELoraConfig, model: nn.Module):
        r"""
            ...
            if p.requires_grad and self.dema:
                ...
                with torch.no_grad():
                    try:
                        ...
                        self.ema_modules[n].data = self.ema_modules[n].data * 0.9999 + p.data * 0.0001
                    except:
                        self.ema_modules[n].data = self.ema_modules[n].data * 0.9999 + p.data * 0.0001
