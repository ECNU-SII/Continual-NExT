...
def prepare_model_inputs_fn_language_modeling(model_input, peft_config: MoELoraConfig):
    """
...
def _get_eva_state_dict(
    ...
    dataloader: Iterable,
    peft_config: Optional[MoELoraConfig],
...
def get_eva_state_dict(
    model: torch.nn.Module,
    dataloader: Iterable,
    peft_config: Optional[MoELoraConfig] = None,
