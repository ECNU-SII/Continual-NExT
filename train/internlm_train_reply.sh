...
CUDA_VISIBLE_DEVICES=0,1,2,3 swift sft --torch_dtype bfloat16 \
    ...
    --adapters /mnt/workspace/hqs/code1/ms-swift-main/output/internlm2_5_reply/2022/checkpoint-260 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3 swift sft --torch_dtype bfloat16 \
    ...
    --adapters /mnt/workspace/hqs/code1/ms-swift-main/output/internlm2_5_reply/2023/checkpoint-280 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3 swift sft --torch_dtype bfloat16 \
    ...
    --adapters /mnt/workspace/hqs/code1/ms-swift-main/output/internlm2_5_reply/2024/checkpoint-380 \
